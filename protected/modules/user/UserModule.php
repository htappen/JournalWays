...
class UserModule extends CWebModule
{
	...
	public $fbRegistrationUrl = array("/user/fbRegistration");	
	 ...
	 * @var boolean
	 */
	public $captcha = array('registration'=>true,'fbregistration'=>false);
	 ...
	 * @return hash string.
	 */
	public static function encrypting($pass="",$salt="") {
		$hash = Yii::app()->getModule('user')->hash;
		if ($hash=="md5")
			return md5($pass.md5($salt));
		if ($hash=="sha1")
			return sha1($pass.sha1($salt));
		else
